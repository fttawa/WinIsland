...
update_available_desc=A new version of WinIsland-X is available (Released: {}). Would you like to update now?
...
update_available_desc=WinIsland-X 有新版本可用 (发布时间: {})。是否现在更新？
